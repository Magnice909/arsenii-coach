...
## Drawer-меню клиента и нумерация упражнений

- В кабинете клиента на телефоне меню теперь тоже открывается через кнопку «Меню» и не занимает верх страницы.
- В тренировке клиента упражнения больше не отображаются чекбоксами. Вместо этого показан порядковый номер упражнения.
- Выполнение тренировки по-прежнему отмечается одной кнопкой «Отметить тренировку».
