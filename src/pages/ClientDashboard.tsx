  ...
  return (
    <div className="app-card rounded-2xl p-5 mt-5">
      ...
      <div className="grid grid-cols-2 md:grid-cols-3 gap-3 mt-4">
        {badges.map((badge) => (
          <div key={badge.label} className="rounded-2xl p-4 flex flex-col items-center text-center gap-2" style={{ background: badge.earned ? "rgba(52,231,166,.10)" : "rgba(255,255,255,.03)", border: badge.earned ? "1px solid rgba(52,231,166,.28)" : "1px solid var(--line)", opacity: badge.earned ? 1 : 0.45 }}>
