...
const FloatingAppPreview = () => {
  return (
    <motion.div className="glass rounded-[2rem] p-5 md:p-6 relative overflow-hidden" initial={{ opacity: 0, x: 28 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: .8, delay: .25 }}>
